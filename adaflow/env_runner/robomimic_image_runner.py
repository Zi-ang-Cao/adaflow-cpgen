...
def create_env(env_meta, shape_meta, camera_depths=False, camera_segmentations=None, enable_render=True):
    ...
    def __init__(self, 
        ...
        def env_fn():
            ...
            if (self.randomize_color \
                ...
                robomimic_env.env = DomainRandomizationWrapper(
                    robomimic_env.env, 
